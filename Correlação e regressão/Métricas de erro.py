...
# Comparando previsões e resultados verdadeiros
print(previsoes, yteste)

from sklearn.metrics import mean_absolute_error, mean_squared_error

# Calculando erro médio absoluto das previsões
print(mean_absolute_error(yteste, previsoes))

# Calculando valor ao quadrado - não é muito usado, porém é utilizado em Redes Neurais
print(mean_squared_error(yteste, previsoes))
print(math.sqrt(mean_squared_error(yteste, previsoes)))